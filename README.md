...
<img alt="leading-scorers" src="screenshots/goalscorers-with-photo.png" width="720">
...
| Feature Detail | Screenshot / 截图 |
|---|---|
| **Hero & stats · 页头与统计**<br>Title with six live stat cards: matches played, goals, scorers, leagues, clubs, matches-with-goals.<br>标题 + 六张实时统计卡（比赛进程/总进球/进球者/联赛/俱乐部/场次）。 | <img src="screenshots/hero-stats.png" width="680"> |
| **Latest Results · 最新赛果**<br>Every finished match grouped and newest-first, regardless of score; goalless matches (incl. 0-0 decided on penalties) show a "No goals" placeholder. Match #, round & group, two-color scoreline, host city, penalty shootout, scorer + club.<br>所有已完赛比赛按比赛分组、最新在前，无论比分；无进球场次（含点球决胜的 0-0）显示「本场无进球」占位。含 Match 编号、轮次与小组、两色比分、主办城市、点球大战、进球者+俱乐部。 | <img src="screenshots/latest-goals.png" width="680"> |
| **Latest Results · earlier days / 按天折叠**<br>Earlier days fold into per-day panels colored by stage (group 1/2/3 = teal/blue/purple, knockouts = gold→red).<br>更早的比赛按天折叠、按阶段着色（小组 1/2/3 = 青/蓝/紫，淘汰赛 = 金→红）。 | <img src="screenshots/latest-goals-days.png" width="680"> |
| **Top Scorers · 射手榜**<br>Goal ranking grouped by goal count; ties broken by assists (per FIFA Golden Boot); tier-colored cards with jersey number and penalty marks.<br>进球数排名、按进球数分组；同分按助攻数排序（贴近 FIFA 金靴规则）；档位配色，含号码徽章与点球标记。 | <img src="screenshots/top-scorers.png" width="680"> |
| **Top Assists · 助攻榜**<br>Assist ranking sourced from ESPN's official tournament leaders, resolved to the player database (Chinese name · club · league); gold/silver/bronze tiers and adaptive filter chips, goals shown alongside.<br>助攻榜，取自 ESPN 官方赛事助攻数据、解析到球员库（中文名·俱乐部·联赛）；金银铜档位配色、动态档位筛选按钮，并同时显示进球数。 | <img src="screenshots/top-assists.png" width="680"> |
| **⭐ Goal Origins · 进球来自哪里** — signature / 招牌板块<br>Three charts (Nation / League / Club), **each with its own** Goals ↔ Scorers toggle and Top 10/15/20/All; the club chart drills down by league.<br>三张图（国家队 / 联赛 / 俱乐部），**每张各自独立**切换进球数 / 进球人数与 Top 10/15/20/全部；俱乐部图可按联赛下钻。 | By Nation / 按国家队<br><img src="screenshots/goal-origins-nation.png" width="560"><br>By League / 按联赛<br><img src="screenshots/goal-origins-league.png" width="560"><br>By Club / 按俱乐部<br><img src="screenshots/goal-origins-club.png" width="560"> |
| **All Players · 全部球员查询**<br>Searchable database of all 1,248 players (incl. 0-goal), four stacking comboboxes.<br>可查询全部 1248 名球员（含 0 球），四个可叠加的搜索下拉。 | <img src="screenshots/all-players.png" width="680"> |
| **Multi-goal · 单场多球**<br>Braces and hat-tricks per match, with match, scoreline, date and venue.<br>单场梅开二度/帽子戏法，附比赛、比分、日期与场地。 | <img src="screenshots/multi-goal.png" width="680"> |
| **Goal Timing · 进球时间分布**<br>Goals by match phase, a per-minute line (with hydration markers), plus earliest & latest goal.<br>进球按阶段分布、每分钟折线（含补水标记），并标出最早/最晚进球。 | <img src="screenshots/goal-timing.png" width="680"> |

Fully bilingual and responsive (phone / tablet / desktop). 全站双语、自适应手机 / 平板 / 电脑。
